...
#rootdir = '/home/x_mirmi/pcons-fold/folding/rosetta/test/rosetta'
...
for core in range(1, cores + 1):
    ...
    plist.append(Popen([rosettadir + '/rosetta_source/bin/AbinitioRelax.static.linuxgccrelease', '@abinitio.options']))
