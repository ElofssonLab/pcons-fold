...
#TODO: parallelize workflow
# IDEA: run alignments at the same time, then run all PSICOV at the same time then run plmDCA on all cores but serially on all alignments.
