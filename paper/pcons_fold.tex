...
\caption{(a) PPV of the predicted contacts when using the native structures against the PPV in the top-ranked models. The color scheme represents TM-scores. (b) shows predicted contacts in the native structure and (c) in the top-ranked model.}\label{fig:vs}
\end{figure*}
