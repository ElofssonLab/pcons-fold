...
related sequences are available. It was shown that the contact
...
have been continuous effort to improve the quality of predicted
...
of 15 proteins as in \cite{marks_protein_2011}. PDB and Uniprot IDs are given in
...
that it uses pseudolikelihood maximization (plm) instead of the mean field approach for
contact prediction.
...
the quality of predicted contacts, i.e. there exist a larger number of
...
In  EVfold-PLM the best method to identify top-ranked models are by
...
to show good ability to identify accurate protein models, ProQ2~\cite{ray_improved_2012} and Dope~\cite{eswar_comparative_2006}.
...
clearly not able to satisfy all constrain. Here, an improved folding
...
Swedish E-science Research Center. DSM, CS and SH are supported by NIH award R01 GM106303.
