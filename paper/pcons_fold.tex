...
(supplementary information). PSICOV \cite{jones_psicov:_2012} was used
in Rosetta/PSICOV.
...
average. In case of EVfold-PLM, Pcons selected the best models on
average. Pcons performed slightly worse than the internal scoring
function of Rosetta on the models from PconsFold and
Rosetta/plmDCA. ProQ2 did not perform well on EVfold-PLM models. ProQ2 performed slightly worse than
...
\subsection{Comparison to EVfold and EVfold-PLM}
...
and PconsFold with 20,000 generated decoys. The results
for  EVfold-PLM were generated using plmDCA instead
of mean field as in the published version. With an average TM-score of 0.55
EVfold using plmDCA performs 15\% better than EVfold with mean field,
