...
slightly more clashes than EVfold models, however backbone 
dihedrals are improved in PconsFold. PconsFold performs 14 \% better on proteins of 
...
quality of Rosetta models is higher than for EVfold models. The percentage of Ramachandran outliers is 0.62 \% for PconsFold and 12.16 \% for EVfold. MolProbity further reports an average clash score of 10.48 for PconsFold and 9.90 for EVfold. The EVfold models have slightly less clashes than the models from PconsFold. The average final MolProbity score is with 1.85 better for PconsFold then 2.38 for EVfold. This corresponds to a better average MolProbity percentile rank of 80.69 for PconsFold than the rank of 54.21 for EVfold.
...
Rosetta itself provides no gain in model native-likeliness. According to MolProbity Rosetta structures are slightly more accurate.

When comparing PPVs we see that there is still room for improvement in the folding protocol.

We propose to use model-PPV as a measure of model quality, or as a stopping criterium for decoy generation. If the native PPV is reached, we can't gain more information from the contact map. Then structural refinement needs to be used to get closer to native conformations. 
