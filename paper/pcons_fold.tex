...
\section{Results:}
Using contacts from PconsC instead of PSICOV or plmDCA increases average model quality, measured in TM-score, by 10\%. PconsFold provides an average increase in TM-score of maximal 17\% compared to EVfold. PconsFold performs best on average and shows significant increase in TM-score in 7 targets on a test dataset of 15 proteins.
...
BPT1\_BOVIN & 0.49 & 0.25 & {\bf 0.5} & 0.44 & 0.28 & ~ \\
CADH1\_HUMAN & 0.55 & 0.54 & {\bf 0.6} & 0.59 & 0.37& ~ \\
CD209\_HUMAN & 0.39 & {\bf 0.64} & 0.62 & 0.48 & 0.4& ~ \\
CHEY\_ECOLI & 0.65 & 0.66 & 0.74 & {\bf 0.82} &  0.81& ~ \\
ELAV4\_HUMAN & 0.57 & 0.61 & 0.57 & {\bf 0.74} & {\bf 0.74}& ~ \\
O45418\_CAEEL & 0.48 & 0.62 & 0.62 & 0.62 & {\bf 0.64}& ~ \\
OMPR\_ECOLI & 0.35 & 0.44 & 0.47 & {\bf 0.59} & {\bf 0.59}& ~ \\
OPSD\_BOVIN & 0.5 & 0.55 & {\bf 0.58} & 0.47 & 0.45 & ~ \\
PCB1\_HUMAN & 0.25 & 0.43 & 0.42 & 0.59 & {\bf 0.7}& ~ \\
RASH\_HUMAN & {\bf 0.7} & 0.62 & 0.6 & 0.56 & 0.61& ~ \\
RNH\_ECOLI & 0.54 & {\bf 0.66} & {\bf 0.66} & 0.64 & 0.58& ~ \\
SPTB2\_HUMAN & 0.37 & 0.51 & 0.5 & 0.7 & {\bf 0.72}& ~ \\
THIO\_ALIAC & 0.55 & 0.56 & 0.61 & {\bf 0.79} & 0.66& ~ \\
TRY2\_RAT & 0.53 * & {\bf 0.78} & {\bf 0.78} & 0.5 & 0.39& ~ \\
YES\_HUMAN & 0.35 & 0.31 & 0.37 & {\bf 0.63} & 0.58& ~ \\ \midrule
Mean & 0.48 & 0.55 & 0.57 & {\bf 0.61} & 0.57& ~ \\ \botrule
