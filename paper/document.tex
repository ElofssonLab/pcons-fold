...
\begin{figure}[!tpb]%figure1
    \centerline{\includegraphics[scale=0.37]{figures/pipeline.png}}
...
\begin{figure}[!tpb]%figure1
    \centerline{\includegraphics[scale=0.5]{figures/scores_nohoms_avg_tmscore.pdf}}
\caption{Average TM-scores.}\label{fig:main}
\end{figure}

\begin{figure}[!tpb]%figure1
    \centerline{\includegraphics[scale=0.5]{figures/TMscore_Ros-C_vs_PPV-PconsC1.pdf}}
\caption{TM-scores against PPV of underlying contact maps.}\label{fig:ppv}
\end{figure}

\begin{figure}[!tpb]%figure1
    \centerline{\includegraphics[scale=0.5]{figures/scores_FADE_depth.pdf}}
\caption{Performance on different well-depths of FADE.}\label{fig:welldepth}
\end{figure}

\begin{figure}[!tpb]%figure1
    \centerline{\includegraphics[scale=0.5]{figures/TMscore_Ros-C-new_vs_EVfold-pcons.pdf}}
