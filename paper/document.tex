...
\begin{figure}[!tpb]%figure1
    \centerline{\includegraphics[scale=1.0]{figures/rosetta.png}}
\caption{Average TM-scores.}\label{fig:ros}
\end{figure}

\begin{figure}[!tpb]%figure1
    \centerline{\includegraphics[scale=1.0]{figures/tmscores.png}}
...
\begin{figure}[!tpb]%figure1
    \centerline{\includegraphics[scale=1.0]{figures/vs.png}}
